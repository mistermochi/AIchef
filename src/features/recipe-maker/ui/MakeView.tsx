...
import { useRecipeMaker, ActiveTimer } from '../model/useRecipeMaker';
...
import { VoiceCommand } from '../../../shared/lib/hooks/useVoiceControl';
...
export const MakeView: React.FC = () => {
  const { state, actions } = useRecipeMaker();
