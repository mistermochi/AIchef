...
/**
 * @component MediaCardMedia
 * @description A container for card media (images or fallback emojis).
 */
export const MediaCardMedia: React.FC<{ src?: string | null; fallbackEmoji?: string; children?: React.ReactNode }> = ({ src, fallbackEmoji, children }) => (
